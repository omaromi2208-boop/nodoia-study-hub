...
export function AppShell({ title, children }: PropsWithChildren<{ title: string }>) {
  ...
  return (
    <div ref={ref} className="min-h-screen bg-background bg-nodoia-veil">
      <div className="absolute inset-0 opacity-70 bg-nodoia-grid" />
      <div className="relative">
        <header className="sticky top-0 z-30 border-b border-border/70 backdrop-blur supports-[backdrop-filter]:bg-background/35">
          <div className="container flex h-14 items-center justify-between px-4">
            <div className="flex items-center gap-2">
              <div className="h-7 w-7 rounded-lg bg-brand/20 ring-1 ring-brand/35 shadow-elev" />
        ...
        <div className="container grid grid-cols-1 gap-5 px-4 pb-20 pt-5 md:grid-cols-[240px_1fr] md:pb-10">
